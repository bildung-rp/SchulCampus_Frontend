...
<main>
    <div class="container" id="container-blue">
        ...
        <div class="bluebox">
            ...
            <div class="col-4">
                <section id="meineDateien" class="inaktiv">
        ...
        <div class="tooltip-iconarea">
            <span class="icon-attention-1"></span>
        </div>
        <div class="tooltip-inaktiv">
            <div class="tooltip-inaktiv-text">Bitte zuerst einloggen, um diese Funktion verwenden zu können!</div>
        </div>
        <div class="tooltip-inaktiv-arrow"></div>
            ...
            <div class="col-4">
                <section id="curriculum" class="inaktiv">
                    <div class="bluebox-lg">
